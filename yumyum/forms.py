...
class RecipeForm(forms.ModelForm):
	title = models.CharField(max_length=128, help_text = "Please enter a recipe title")
	cooking_time = models.IntegerField(default=60, help_text= "Please enter cooking time in minutes") #in minutes
	direction = models.TextField(max_length=1000, help_text = "Please enter cooking directions")
